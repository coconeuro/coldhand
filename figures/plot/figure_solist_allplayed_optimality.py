...
plt.xticks([0, 1], ['Post-\nsuccess', 'Post-\nfailure'])
plt.xlim(-0.5, 1.5)
plt.ylim(97.86, 97.905)
plt.yticks(np.arange(97.86, 97.905, 0.01))
# plt.ylim(y_min, y_max)
# plt.ylim(-0.0275, -0.0075)
# plt.yticks(np.arange(-0.022, -0.0119, 0.002))
# plt.title('Earned reward\n(Scope: all games)')
# plt.text(-0.22, 1.1, ' Scope:', transform=plt.gca().transAxes, fontsize=10, fontweight='bold', color='#222', clip_on=False, bbox=dict(facecolor='#eee', ec='none', pad=3.25))
# plt.text(0.11, 1.1, 'all following games ', transform=plt.gca().transAxes, fontsize=10, color='#222', clip_on=False, bbox=dict(facecolor='#eee', ec='none', pad=3.25))
plt.text(-0.22, 1.055, 'Scope:', transform=plt.gca().transAxes, fontsize=11, fontweight='bold', color='#222', clip_on=False, bbox=dict(facecolor='#eee', ec='none', pad=3.25))
