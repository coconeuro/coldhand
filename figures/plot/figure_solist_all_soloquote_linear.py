...
plt.xlim(-0.5, 1.5)
plt.ylim(12, 12.87)
# plt.yticks(np.arange(12.1, 12.71, 0.1))
# plt.yticks(np.arange(13.5, 15.1, 0.5))
...
# plt.text(0.08, 1.055, 'all following games ', transform=plt.gca().transAxes, fontsize=10, color='#222', clip_on=False, bbox=dict(facecolor='#eee', ec='none', pad=3.25))
...
plt.text(0.11, 1.055, 'all contracts', transform=plt.gca().transAxes, fontsize=11, color='#222', clip_on=False, bbox=dict(facecolor='#eee', ec='none', pad=3.25))
# plt.title('Soloist frequency\n(Scope: all games)')
plt.ylabel(f'p(Solo), %')
