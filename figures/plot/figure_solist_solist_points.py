...
plt.ylim(73.2, 73.85)
plt.yticks(np.arange(73.2, 73.81, 0.2))
# plt.text(0.03, 0.92, 'Scope:', transform=plt.gca().transAxes, fontsize=10, fontweight='bold', color='#222')
# plt.text(0.315, 0.92, 'following solo games', transform=plt.gca().transAxes, fontsize=10, color='#222')
...
plt.text(0.11, 1.055, 'declared solo contracts', transform=plt.gca().transAxes, fontsize=11, color='#222', clip_on=False, bbox=dict(facecolor='#eee', ec='none', pad=3.25))
# plt.title('Earned points')
plt.ylabel(f'Points')
# plt.title('Scope: solos')
