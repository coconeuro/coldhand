...
# export_regression_table(result, __file__, ci95_as_percent=True, print_google_doc_size=True)
export_regression_table(result, __file__, ci95_as_percent=False, print_google_doc_size=True, exact_p=True)
print(patsy)

# print(f'Effect lme4: {100*result.iloc[1]['Estimate']:.5f}%  ||  Effect correction: {100*(ff_cor.loc['prev_won_cor', 'av'] - ff_cor.loc['prev_lost_cor', 'av']):.5f}%')
