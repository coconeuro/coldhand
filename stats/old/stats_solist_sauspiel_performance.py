...
cols = [
    ...
    'rule_kurze', 'game_type', 'cur_pos', 'player_role',
    'player_augen', 'regquality', 'regquality_sauspielgegner_cards_best'
]
...
df['regquality_sauspielgegner_cards_best'] -= df['regquality_sauspielgegner_cards_best'].mean()
df['regquality_sauspielgegner_cards_best'] /= df['regquality_sauspielgegner_cards_best'].std()

regs = [
    'prev_won',
    'regquality_sauspielgegner_cards_best',
    'C(rule_kurze)',
    # 'C(game_type)',
    'C(player_role)',
    'C(cur_pos)'
