...
dv = 'performance'
cols = [
    'subject',  'player_augen', 'regquality', var_valid, 'tdiff_new_max3', 'prev_lost', 'prev_won', 'prev_fold',
    'rule_kurze', 'game_type', 'cur_pos', 'spielstaerke', 'regquality_solist',
    'spielerfolg_gegenspieler_worst', 'spielerfolg_gegenspieler_middle', 'spielerfolg_gegenspieler_best',
...
df['regquality_sologegner'] = (df['regquality_sologegner_cards_best'] + df['regquality_sologegner_cards_middle'] + df['regquality_sologegner_cards_worst']) / 3
...
if reload:
    regs = [
        ...
        # 'regquality_sologegner',
        # 'regquality_sologegner_cards_middle',
        # 'regquality_sologegner_cards_worst',
