...
from stats.z_transform import std_z_transform_player_all, mean_z_transform_player_all
...
df['player_optimality_ratio_z'] = df['player_optimality_ratio'] - mean_z_transform_player_all
df['player_optimality_ratio_z'] /= std_z_transform_player_all
