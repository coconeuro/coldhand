...
tmax = 900
cols = [
    'subject',  'player_augen', 'regquality', var_valid, 'tdiff_new_max3_av', 'prev_lost', 'prev_won', 'prev_fold',
...
df.loc[df.regquality < 0, 'regquality'] = 0
df.loc[df.regquality > 120, 'regquality'] = 120
df['efficiency'] = df['player_augen'] - df['regquality']
