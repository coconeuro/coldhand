...
df = df[df[f'valid_{var_valid}'] & (df[f'tdiff_{var_valid}'] < tmax) & (df['cur_pos'] == 0)]
...
export_regression_table(result, __file__, ci95_as_percent=True, print_google_doc_size=True, exact_p=True, include_df=True)
print(patsy)
